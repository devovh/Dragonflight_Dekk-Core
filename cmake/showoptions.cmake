...
if (WITH_ACTIVATION_KEY)
    message("")
	message("* Build with Activation Key System : Yes (default)")
	add_definitions(-DACTIVATIONKEY)
	add_definitions(-DTRINITY)
else()
    message("")
	message("*** Be Careful! *** Build with Activation Key System : No")
endif()
