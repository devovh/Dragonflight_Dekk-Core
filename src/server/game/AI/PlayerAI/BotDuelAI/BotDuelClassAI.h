...
class TC_GAME_API DuelWarriorAI : public BotDuelAI, public BotWarriorSpells
{
public:
...
class TC_GAME_API DuelPaladinAI : public BotDuelAI, public BotPaladinSpells
{
public:
...
class TC_GAME_API DuelDeathknightAI : public BotDuelAI, public BotDeathknightSpells
{
public:
...
class TC_GAME_API DuelRogueAI : public BotDuelAI, public BotRogueSpells
{
public:
...
class TC_GAME_API DuelDruidAI : public BotDuelAI, public BotDruidSpells
{
public:
...
class TC_GAME_API DuelHunterAI : public BotDuelAI, public BotHunterSpells
{
public:
...
class TC_GAME_API DuelShamanAI : public BotDuelAI, public BotShamanSpells
{
public:
...
class TC_GAME_API DuelMageAI : public BotDuelAI, public BotMageSpells
{
public:
...
class TC_GAME_API DuelWarlockAI : public BotDuelAI, public BotWarlockSpells
{
public:
...
class TC_GAME_API DuelPriestAI : public BotDuelAI, public BotPriestSpells
{
public:
