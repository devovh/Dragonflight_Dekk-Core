...
class TC_GAME_API FieldWarriorAI : public BotFieldAI, public BotWarriorSpells
{
public:
...
class TC_GAME_API FieldPaladinAI : public BotFieldAI, public BotPaladinSpells
{
public:
...
class TC_GAME_API FieldDeathknightAI : public BotFieldAI, public BotDeathknightSpells
{
public:
...
class TC_GAME_API FieldRogueAI : public BotFieldAI, public BotRogueSpells
{
public:
...
class TC_GAME_API FieldDruidAI : public BotFieldAI, public BotDruidSpells
{
public:
...
class TC_GAME_API FieldHunterAI : public BotFieldAI, public BotHunterSpells
{
public:
...
class TC_GAME_API FieldShamanAI : public BotFieldAI, public BotShamanSpells
{
public:
...
class TC_GAME_API FieldMageAI : public BotFieldAI, public BotMageSpells
{
public:
...
class TC_GAME_API FieldWarlockAI : public BotFieldAI, public BotWarlockSpells
{
public:
...
class TC_GAME_API FieldPriestAI : public BotFieldAI, public BotPriestSpells
{
public:
