...
namespace BattlePets { struct BattlePet; };
...
class TC_GAME_API BattlePet
{
    public:
        ...
        void ChangeQuality(Player* OwningPlayer, uint32 NewQuality, bool bSendUpdate);
        void ChangeLevel(Player* OwningPlayer, uint32 NewLevel, bool bSendUpdate);
