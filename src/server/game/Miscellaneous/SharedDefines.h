...
// CreatureFamily.dbc (10.0.5.47660)
enum CreatureFamily
{
...
// TotemCategory.db2 (10.0.5.47660)
enum TotemCategory
{
...
enum ChallengeMode
{
    ...
    GOB_CHALLENGER_DOOR = 338195, // dome 
