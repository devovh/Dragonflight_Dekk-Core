...
class TC_GAME_API AuraScript : public _SpellScript
{
    ...
    public:
        ...
        // Executed when the aura is tried to apply, no matter if it was actually successfully applied. Usable for spellcast hooking auras
        HookList<EffectApplyHandler> OnEffectAttemptApply;
