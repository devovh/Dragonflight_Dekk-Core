...
public:
    ...
    class spell_dh_artifact_soul_carver_AuraScript : public AuraScript
    {
        ...
        void PeriodicTick(AuraEffect const* /*aurEff*/)
        {
            ...
            //caster->CastCustomSpell(SPELL_DH_SHATTERED_SOULS_MISSILE, SPELLVALUE_BASE_POINT0, SPELL_DH_LESSER_SOUL_SHARD, caster, true); same here CastSpellExtraArgs
        }
...
struct at_shattered_soul_fragment : AreaTriggerAI
{
    ...
    void OnUnitEnter(Unit* unit) override
    {
        ...
        case 10665:
            ...
            else if (at->GetCaster()->ToPlayer()->GetSpecializationId() == TALENT_SPEC_DEMON_HUNTER_VENGEANCE)
            {
