                        ...
                        switch (uiSummonMask)
                        {
                            case 1:
                            {
                                ...
                                if (!vehicle->GetPassenger(0))
                                    if (TempSummon* pygmy = me->SummonCreature(44897, x, y, z, 0.0f, TEMPSUMMON_CORPSE_DESPAWN, 30s))
                                ...
                                if (Unit* passenger = vehicle->GetPassenger(0))
                                    if (Vehicle* veh_pygmy = passenger->GetVehicleKit())
                                        if (!veh_pygmy->GetPassenger(0))
                                            if (Creature* pygmy = me->SummonCreature(44898, x, y, z, 0.0f, TEMPSUMMON_CORPSE_DESPAWN, 30s))
